...
export default function Kontakt() {
    ...
    return (
        <div className=" w-full relative overflow-hidden">
            <Menu />
            <div className='h-full xl:h-screen w-full relative flex flex-col xl:flex-row overflow-hidden'>
                ...
                <div className='flex flex-col mt-[50px] lg:mt-[60px] xl:mt-[100px] mx-[20px] lg:mx-[50px]'>
                    <h1 className='text-[40px] lg:text-[60px] 2xl:text-[70px] 4xl:text-[80px] font-poppins font-bold text-stone-800' >Kontakt</h1>
                    <p className='text-gray-600 text-[18px] lg:text-[20px] 2xl:text-[22px] 4xl:text-[24px] mt-[15px] leading-[1.3]'>Ova stranica je informativnog karaktera.<br className="" /> Za više informacija i
                        narudžbe možete se obratiti našem prodajnom predstavniku na:
                    </p>
                    <div className='pt-[30px] 3xl:pt-[60px]  z-20'>
                        <p className='text-black font-poppins text-[24px] md:text-[20px] lg:text-[22px] 2xl:text-[24px] 4xl:text-[26px] font-light leading-[2] tracking-wide'>EMAIL</p>
                        <div className='flex flex-col'>
                            ...
                            >
                                <p className='text-black font-poppins text-[16px] xs5:text-[18px] md:text-[24px] lg:text-[26px] 2xl:text-[28px] 4xl:text-[30px] font-normal leading-[1.3] tracking-wide xs:pr-[20px]'>loveyourhair.solomun@gmail.com</p>
                    ...
                    <div className="pt-[30px] 3xl:pt-[60px] z-20 pb-[100px]">
                        <p className="text-black font-poppins text-[24px] md:text-[20px] lg:text-[22px] 2xl:text-[24px] 4xl:text-[26px] font-light leading-[2] tracking-wide">MOBITEL</p>
                        <div className="flex flex-col">
                            <div className="flex justify-between cursor-pointer" onClick={() => {
                                window.location.href = "tel:+385915285447";
                            }}>
                                <p className="text-black font-poppins text-[16px] xs5:text-[18px] md:text-[24px] lg:text-[26px] 2xl:text-[28px] 4xl:text-[30px] font-normal leading-[1.3] tracking-wide xs:pr-[20px]">+385 91 5285 447</p>
                                <div className="pr-[5px] flex justify-center items-center ">
