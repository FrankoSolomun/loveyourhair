  ...
  return (
    <div className="fixed top-0 w-full z-[100] ">
      <div className="h-16 w-full bg-black flex items-center justify-between">
        ...
        <div className='absolute top-[12px] right-[20px] md:right-[40px] cursor-pointer block xl:hidden' onClick={handleClick}>
        ...
        <motion.div
        className="absolute top-0 left-0 w-full h-screen bg-black z-[99] justify-center items-center flex flex-col"
        initial={{ opacity: 0 }}
        ...
        >
          ...
          <div className='absolute top-[10px] right-[15px] cursor-pointer' onClick={handleClick}>
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-x" width="50" height="50" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div className="flex flex-col space-y-10">
              <button className="bg-stone-800 px-8 py-4 rounded-full"><a href="/" className="text-[40px] font-poppins font-semibold text-white">Početna</a></button>
              <button className="bg-stone-800 px-8 py-4 rounded-full"><a href="/kontakt" className="text-[40px] font-poppins font-semibold text-white">Kontakt</a></button>
              <button className="bg-stone-800 px-8 py-4 rounded-full"><a href="/o-nama" className="text-[40px] font-poppins font-semibold text-white">O nama</a></button>
            </div>
        </motion.div>
